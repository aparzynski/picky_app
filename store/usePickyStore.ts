...
export const usePickyStore = create<PickyState>((set) => ({
  ...
  discoverCategories: [
    ...
    { id: 'cat-6', title: 'Weeknight Winners',   recipeIds: ['n1', 'n2', 'n3', 'n9'] },
    { id: 'cat-7', title: 'Global Flavors',      recipeIds: ['n5', 'n6', 'n7', 'n8'] },
    { id: 'cat-8', title: 'Soups & Comfort',     recipeIds: ['n4', 'n10', 'n12', 'n17'] },
    { id: 'cat-9', title: 'Plant-Forward',       recipeIds: ['n14', 'n16', 'n20', 'n21'] },
    { id: 'cat-10', title: 'Fan Favorites',      recipeIds: ['n13', 'n15', 'n18', 'n19'] },
  ],
