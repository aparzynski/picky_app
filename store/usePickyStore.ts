...
export type KitchenItem = {
  ...
  quantity: string
  emoji: string
  category: 'produce' | 'protein' | 'dairy' | 'frozen meals' | 'breast milk'
...
export const usePickyStore = create<PickyState>((set) => ({
  ...
  discoverCategories: [
    ...
    { id: 'cat-6', title: 'Weeknight Winners',   recipeIds: ['n1', 'n2', 'n3', 'n4'] },
    { id: 'cat-7', title: 'Global Flavors',      recipeIds: ['n5', 'n6', 'n7', 'n8'] },
    { id: 'cat-8', title: 'Soups & Comfort',     recipeIds: ['n9', 'n10', 'n11', 'n12'] },
    { id: 'cat-9', title: 'Plant-Forward',       recipeIds: ['n13', 'n14', 'n15', 'n16'] },
    { id: 'cat-10', title: 'Fan Favorites',      recipeIds: ['n17', 'n18', 'n19', 'n20'] },
  ],
  ...
  recipes: {
    ...
    n1: {
      ...
      description: 'Crispy romaine, shaved parmesan, and grilled chicken tossed in classic Caesar dressing, all bundled in a toasted flour tortilla.',
      cookTime: 20,
      serves: 4,
      rating: 4.7,
      calories: 480,
      tags: ['Quick & Easy', 'Kid-Friendly'],
      imageUrl: '/mock/n1.jpg',
      ingredients: [
        { name: '2 grilled chicken breasts, sliced', state: 'missing item' },
        { name: '4 large flour tortillas', state: 'in pantry' },
        { name: '3 cups romaine lettuce, chopped', state: 'missing item' },
        { name: '¼ cup Caesar dressing', state: 'in pantry' },
        { name: '⅓ cup shaved parmesan', state: 'missing item' },
        { name: '1 cup croutons', state: 'in pantry' },
      ],
      instructions: [
        'Grill chicken breasts over medium-high heat for 6–7 minutes per side. Rest 5 minutes, then slice thin.',
        'Toss romaine, parmesan, and croutons with Caesar dressing.',
        'Warm tortillas in a dry skillet for 30 seconds per side.',
        'Divide salad and chicken between tortillas, roll tightly, and slice in half.',
      ],
    },
    n2: {
      id: 'n2',
      name: 'Beef & Broccoli Noodle Bowl',
      description: 'Tender strips of flank steak and crisp broccoli florets in a savory ginger-soy sauce over lo mein noodles.',
      cookTime: 25,
      serves: 4,
      rating: 4.9,
      calories: 560,
      tags: ['Family Favorite', 'One Pan'],
      imageUrl: '/mock/n2.jpg',
      ingredients: [
        { name: '1 lb flank steak, sliced thin', state: 'missing item' },
        { name: '3 cups broccoli florets', state: 'in pantry' },
        { name: '8 oz lo mein noodles', state: 'in pantry' },
        { name: '3 tbsp soy sauce', state: 'in pantry' },
        { name: '1 tbsp oyster sauce', state: 'missing item' },
        { name: '1 tsp sesame oil', state: 'in pantry' },
        { name: '1 tbsp fresh ginger, grated', state: 'missing item' },
        { name: '3 cloves garlic', state: 'in pantry' },
      ],
      instructions: [
        'Cook noodles per package directions. Drain and set aside.',
        'Whisk soy sauce, oyster sauce, sesame oil, ginger, and garlic.',
        'Sear steak in a hot oiled wok for 2–3 minutes. Remove.',
        'Stir-fry broccoli for 3 minutes. Add noodles and sauce, toss to coat.',
        'Return steak, toss everything together, and serve hot.',
      ],
    },
    n3: {
      id: 'n3',
      name: 'Sheet Pan Chicken Fajitas',
      description: 'Juicy chicken thighs, peppers, and onions roasted together on one pan with smoky fajita spices — dinner in 30 minutes.',
      cookTime: 30,
      serves: 6,
      rating: 4.8,
      calories: 420,
      tags: ['Less Dishes', 'Lots of leftovers'],
      imageUrl: '/mock/n3.jpg',
      ingredients: [
        { name: '1.5 lbs chicken thighs, sliced', state: 'missing item' },
        { name: '3 bell peppers (mixed), sliced', state: 'missing item' },
        { name: '1 large onion, sliced', state: 'in pantry' },
        { name: '2 tbsp olive oil', state: 'in pantry' },
        { name: '1 tbsp fajita seasoning', state: 'in pantry' },
        { name: 'Flour tortillas, for serving', state: 'in pantry' },
        { name: 'Lime, sour cream, salsa', state: 'missing item' },
      ],
      instructions: [
        'Preheat oven to 425°F.',
        'Toss chicken, peppers, and onion with olive oil and fajita seasoning on a sheet pan.',
        'Spread in an even layer and roast for 25–28 minutes until chicken is cooked through.',
    ...
    n4: {
      ...
      description: 'Velvety roasted tomato soup with a swirl of cream and handfuls of fresh basil. Pairs perfectly with grilled cheese.',
      cookTime: 40,
      serves: 6,
      rating: 4.6,
      calories: 290,
      tags: ['Comfort Food', 'Vegetarian'],
      imageUrl: '/mock/n4.jpg',
      ingredients: [
        { name: '2 lbs roma tomatoes, halved', state: 'missing item' },
        { name: '1 can crushed tomatoes (28 oz)', state: 'in pantry' },
        { name: '1 yellow onion, diced', state: 'in pantry' },
        { name: '4 cloves garlic', state: 'in pantry' },
        { name: '½ cup heavy cream', state: 'in pantry' },
        { name: '1 cup fresh basil leaves', state: 'missing item' },
        { name: '2 tbsp olive oil', state: 'in pantry' },
        { name: '2 cups vegetable broth', state: 'in pantry' },
      ],
      instructions: [
        'Roast tomatoes with olive oil at 400°F for 25 minutes.',
        'Sauté onion and garlic until soft. Add roasted tomatoes, crushed tomatoes, and broth.',
    ...
    n5: {
      ...
      description: 'Glossy teriyaki-glazed chicken thighs over steamed jasmine rice with steamed broccoli and a sesame drizzle.',
      cookTime: 25,
      serves: 4,
      rating: 4.9,
      calories: 510,
      tags: ['Kid-Friendly', 'High Protein'],
      imageUrl: '/mock/n5.jpg',
      ingredients: [
        { name: '1.5 lbs boneless chicken thighs', state: 'missing item' },
        { name: '2 cups jasmine rice', state: 'in pantry' },
        { name: '3 cups broccoli florets', state: 'in pantry' },
        { name: '¼ cup soy sauce', state: 'in pantry' },
        { name: '2 tbsp honey', state: 'in pantry' },
        { name: '1 tbsp rice vinegar', state: 'missing item' },
        { name: '1 tsp sesame oil', state: 'in pantry' },
        { name: 'Sesame seeds, green onions', state: 'missing item' },
      ],
      instructions: [
        'Cook rice per package directions.',
        'Whisk soy sauce, honey, rice vinegar, and sesame oil for teriyaki sauce.',
        'Pan-fry chicken thighs 5–6 minutes per side. Add sauce and simmer 2 minutes until glazed.',
        'Steam broccoli. Assemble bowls with rice, chicken, and broccoli. Garnish.',
      ],
    },
    n6: {
      id: 'n6',
      name: 'Spinach & Feta Stuffed Chicken',
      description: 'Juicy chicken breasts stuffed with wilted spinach, creamy feta, and sun-dried tomatoes, then baked golden.',
      cookTime: 40,
      serves: 4,
      rating: 4.7,
      calories: 450,
      tags: ['High Protein', 'Impressive'],
      imageUrl: '/mock/n6.jpg',
      ingredients: [
        { name: '4 boneless chicken breasts', state: 'missing item' },
        { name: '2 cups baby spinach', state: 'missing item' },
        { name: '½ cup feta cheese, crumbled', state: 'missing item' },
        { name: '¼ cup sundried tomatoes', state: 'in pantry' },
        { name: '2 cloves garlic, minced', state: 'in pantry' },
        { name: '2 tbsp olive oil', state: 'in pantry' },
        { name: 'Salt, pepper, oregano', state: 'in pantry' },
      ],
      instructions: [
        'Preheat oven to 400°F.',
        'Sauté spinach and garlic until wilted. Combine with feta and sundried tomatoes.',
        'Cut a pocket in each chicken breast. Stuff with spinach mixture and secure with toothpicks.',
        'Season, sear in oven-safe skillet, then bake 20–22 minutes.',
      ],
    },
    n7: {
      id: 'n7',
      name: 'Shrimp Tacos with Mango Salsa',
      description: 'Chili-lime shrimp piled into warm corn tortillas with a sweet mango salsa and creamy chipotle slaw.',
      cookTime: 20,
      serves: 4,
      rating: 4.8,
      calories: 390,
      tags: ['Quick & Easy', 'Summery'],
      imageUrl: '/mock/n7.jpg',
      ingredients: [
        { name: '1 lb large shrimp, peeled', state: 'missing item' },
        { name: '1 ripe mango, diced', state: 'missing item' },
        { name: '8 small corn tortillas', state: 'in pantry' },
        { name: '1½ cups shredded cabbage', state: 'missing item' },
        { name: '2 tbsp chipotle sauce', state: 'in pantry' },
        { name: '2 tbsp sour cream', state: 'in pantry' },
        { name: 'Lime, cilantro, red onion', state: 'missing item' },
        { name: 'Chili powder, cumin, garlic', state: 'in pantry' },
      ],
      instructions: [
        'Toss shrimp with chili powder, cumin, garlic, and lime juice. Cook in hot skillet 1–2 min per side.',
        'Mix mango with red onion, cilantro, and lime juice for salsa.',
        'Stir chipotle sauce into sour cream for the slaw dressing. Toss with cabbage.',
        'Warm tortillas. Layer slaw, shrimp, and mango salsa.',
      ],
    },
    n8: {
      id: 'n8',
      name: 'Pesto Gnocchi with Cherry Tomatoes',
      description: 'Pillowy potato gnocchi tossed in bright basil pesto with burst cherry tomatoes and toasted pine nuts.',
      cookTime: 15,
      serves: 4,
      rating: 4.8,
      calories: 490,
      tags: ['Quick & Easy', 'Vegetarian'],
      imageUrl: '/mock/n8.jpg',
      ingredients: [
        { name: '1 lb potato gnocchi', state: 'in pantry' },
        { name: '1 cup cherry tomatoes', state: 'missing item' },
        { name: '⅓ cup basil pesto', state: 'in pantry' },
        { name: '¼ cup pine nuts', state: 'missing item' },
        { name: '¼ cup parmesan, grated', state: 'in pantry' },
        { name: '2 tbsp olive oil', state: 'in pantry' },
      ],
      instructions: [
        'Cook gnocchi per package directions. Reserve ¼ cup pasta water.',
        'Blister cherry tomatoes in olive oil over high heat, 3–4 minutes.',
        'Toss gnocchi with pesto, adding pasta water to loosen.',
        'Fold in tomatoes. Top with pine nuts and parmesan.',
      ],
    },
    n9: {
      id: 'n9',
      name: 'Greek Chicken Bowls',
      description: 'Marinated grilled chicken over cucumber-tomato salad, creamy tzatziki, olives, and warm pita.',
      cookTime: 30,
      serves: 4,
      rating: 4.7,
      calories: 500,
      tags: ['High Protein', 'Mediterranean'],
      imageUrl: '/mock/n9.jpg',
      ingredients: [
        { name: '1.5 lbs chicken thighs', state: 'missing item' },
        { name: '1 cucumber, diced', state: 'missing item' },
        { name: '1 cup cherry tomatoes, halved', state: 'missing item' },
        { name: '½ cup kalamata olives', state: 'missing item' },
        { name: '½ cup tzatziki', state: 'missing item' },
        { name: '4 pita breads', state: 'in pantry' },
        { name: 'Lemon, olive oil, oregano, garlic', state: 'in pantry' },
        { name: '½ cup feta, crumbled', state: 'missing item' },
      ],
      instructions: [
        'Marinate chicken with lemon, olive oil, oregano, and garlic for 15 minutes.',
        'Grill chicken 6–7 min per side. Rest and slice.',
        'Toss cucumber, tomatoes, and olives with olive oil and lemon.',
        'Assemble bowls with chicken, salad, tzatziki, feta, and warm pita.',
      ],
    },
    n10: {
      id: 'n10',
      name: 'Fully Loaded Nachos',
      description: 'Crispy tortilla chips layered with melted cheddar and pepper jack, seasoned beef, jalapeños, and all the toppings.',
      cookTime: 20,
      serves: 6,
      rating: 4.9,
      calories: 680,
      tags: ['Crowd Pleaser', 'Game Night'],
      imageUrl: '/mock/n10.jpg',
      ingredients: [
        { name: '1 bag tortilla chips', state: 'in pantry' },
        { name: '1 lb ground beef', state: 'missing item' },
        { name: '1½ cups cheddar + pepper jack, shredded', state: 'in pantry' },
        { name: '1 can black beans, drained', state: 'in pantry' },
        { name: 'Jalapeños, pickled', state: 'in pantry' },
        { name: 'Sour cream, guacamole, salsa', state: 'missing item' },
        { name: '1 packet taco seasoning', state: 'in pantry' },
      ],
      instructions: [
        'Preheat oven to 400°F.',
        'Brown beef with taco seasoning. Drain fat.',
        'Layer chips, beef, beans, and cheese on a sheet pan.',
    ...
    n11: {
      id: 'n11',
      name: 'Egg-Fried Rice',
      description: 'Classic takeout-style fried rice with scrambled eggs, peas, carrots, and soy sauce. Ready faster than delivery.',
      cookTime: 15,
      serves: 4,
      rating: 4.7,
      calories: 380,
      tags: ['Quick & Easy', 'Kid-Friendly', 'Vegetarian'],
      imageUrl: '/mock/n11.jpg',
      ingredients: [
        { name: '3 cups cooked day-old rice', state: 'in pantry' },
        { name: '3 eggs', state: 'in pantry' },
        { name: '1 cup frozen peas and carrots', state: 'in pantry' },
        { name: '3 tbsp soy sauce', state: 'in pantry' },
        { name: '1 tbsp sesame oil', state: 'in pantry' },
        { name: '3 cloves garlic, minced', state: 'in pantry' },
        { name: '2 green onions, sliced', state: 'missing item' },
      ],
      instructions: [
        'Heat oil in a wok or large skillet over high heat.',
        'Add garlic and frozen vegetables. Stir-fry 2 minutes.',
        'Push to the side and scramble eggs in the pan.',
        'Add rice, soy sauce, and sesame oil. Stir-fry everything together 3–4 minutes.',
    ...
    n12: {
      ...
      description: 'Italian sausage, roasted bell peppers, and onions in a rich tomato sauce over rigatoni.',
      cookTime: 35,
      serves: 6,
      rating: 4.8,
      calories: 590,
      tags: ['Lots of leftovers', 'Hearty'],
      imageUrl: '/mock/n12.jpg',
      ingredients: [
        { name: '1 lb Italian sausage, sliced', state: 'missing item' },
        { name: '2 bell peppers, sliced', state: 'missing item' },
        { name: '1 onion, sliced', state: 'in pantry' },
        { name: '1 lb rigatoni', state: 'in pantry' },
        { name: '1 can crushed tomatoes (28 oz)', state: 'in pantry' },
        { name: '4 cloves garlic', state: 'in pantry' },
        { name: 'Red pepper flakes, Italian seasoning', state: 'in pantry' },
      ],
      instructions: [
        'Brown sausage in a large skillet. Remove and set aside.',
        'Sauté peppers and onion in the same pan until softened.',
        'Add garlic and cook 1 minute. Add crushed tomatoes and simmer 15 minutes.',
        'Cook rigatoni. Toss pasta with sauce and sausage.',
      ],
    },
    n13: {
      id: 'n13',
      name: 'Crispy Baked Chicken Tenders',
      description: 'Panko-crusted chicken tenders baked (not fried!) until shatteringly crispy. Great with honey mustard.',
      cookTime: 25,
      serves: 4,
      rating: 4.8,
      calories: 370,
      tags: ['Kid-Friendly', 'High Protein'],
      imageUrl: '/mock/n13.jpg',
      ingredients: [
        { name: '1.5 lbs chicken tenders', state: 'missing item' },
        { name: '1½ cups panko breadcrumbs', state: 'in pantry' },
        { name: '2 eggs', state: 'in pantry' },
        { name: '½ cup flour', state: 'in pantry' },
        { name: '1 tsp garlic powder, paprika', state: 'in pantry' },
        { name: 'Salt and pepper', state: 'in pantry' },
        { name: 'Honey mustard, for dipping', state: 'in pantry' },
      ],
      instructions: [
        'Preheat oven to 425°F. Line a baking sheet with a wire rack.',
        'Set up breading station: flour, egg, panko + spices.',
        'Bread each tender: flour → egg → panko. Place on rack.',
        'Bake 20–22 minutes, flipping halfway, until golden and cooked through.',
      ],
    },
    n14: {
      id: 'n14',
      name: 'Lentil & Vegetable Soup',
      description: 'A hearty, warming soup packed with red lentils, kale, carrots, and cumin. Nutritious and endlessly satisfying.',
      cookTime: 35,
      serves: 8,
      rating: 4.6,
      calories: 280,
      tags: ['Vegetarian', 'Lots of leftovers', 'Healthy'],
      imageUrl: '/mock/n14.jpg',
      ingredients: [
        { name: '1½ cups red lentils', state: 'in pantry' },
        { name: '2 carrots, diced', state: 'in pantry' },
        { name: '2 celery stalks, diced', state: 'missing item' },
        { name: '2 cups kale, chopped', state: 'missing item' },
        { name: '1 can diced tomatoes', state: 'in pantry' },
        { name: '6 cups vegetable broth', state: 'in pantry' },
        { name: '1 tsp cumin, turmeric, coriander', state: 'in pantry' },
        { name: '1 lemon, juiced', state: 'missing item' },
      ],
      instructions: [
        'Sauté onion, carrots, and celery until softened.',
        'Add spices and cook 1 minute. Add lentils, tomatoes, and broth.',
        'Bring to a boil, reduce heat, and simmer 20 minutes until lentils are tender.',
    ...
    n15: {
      ...
      description: 'Herby ground turkey meatballs simmered in a simple, rustic marinara. Serve over spaghetti or with crusty bread.',
      cookTime: 40,
      serves: 6,
      rating: 4.7,
      calories: 440,
      tags: ['High Protein', 'Lots of leftovers'],
      imageUrl: '/mock/n15.jpg',
      ingredients: [
        { name: '1.5 lbs ground turkey', state: 'missing item' },
        { name: '½ cup breadcrumbs', state: 'in pantry' },
        { name: '1 egg', state: 'in pantry' },
        { name: '¼ cup parmesan', state: 'in pantry' },
        { name: '2 cloves garlic, minced', state: 'in pantry' },
        { name: '1 jar marinara sauce (24 oz)', state: 'in pantry' },
        { name: '1 lb spaghetti', state: 'in pantry' },
        { name: 'Fresh basil, Italian seasoning', state: 'in pantry' },
      ],
      instructions: [
        'Mix turkey, breadcrumbs, egg, parmesan, garlic, and seasoning. Roll into 1.5-inch balls.',
        'Brown meatballs in olive oil, 2 minutes per side.',
        'Add marinara, cover, and simmer 20 minutes.',
        'Cook spaghetti. Serve meatballs and sauce over pasta.',
      ],
    },
    n16: {
      id: 'n16',
      name: 'Sweet Potato & Black Bean Tacos',
      description: 'Roasted sweet potato cubes and spiced black beans in corn tortillas with avocado crema and pickled onions.',
      cookTime: 35,
      serves: 4,
      rating: 4.7,
      calories: 410,
      tags: ['Vegan', 'Plant-Forward'],
      imageUrl: '/mock/n16.jpg',
      ingredients: [
        { name: '2 large sweet potatoes, cubed', state: 'missing item' },
        { name: '1 can black beans, drained', state: 'in pantry' },
        { name: '8 small corn tortillas', state: 'in pantry' },
        { name: '1 avocado', state: 'missing item' },
        { name: '½ cup Greek yogurt', state: 'in pantry' },
        { name: 'Red onion, lime, cilantro', state: 'missing item' },
        { name: 'Cumin, chili powder, smoked paprika', state: 'in pantry' },
      ],
      instructions: [
        'Toss sweet potato with oil and spices. Roast at 425°F for 25 minutes.',
        'Warm black beans with remaining spices.',
        'Blend avocado with yogurt and lime for crema.',
        'Warm tortillas. Fill with sweet potato, beans, crema, and pickled onions.',
      ],
    },
    n17: {
      id: 'n17',
      name: 'Chicken Pot Pie Soup',
      description: 'All the cozy filling of a classic pot pie — tender chicken, peas, carrots, and a creamy broth — in one simple pot.',
      cookTime: 35,
      serves: 6,
      rating: 4.9,
      calories: 460,
      tags: ['Comfort Food', 'Lots of leftovers'],
      imageUrl: '/mock/n17.jpg',
      ingredients: [
        { name: '1.5 lbs cooked chicken, shredded', state: 'missing item' },
        { name: '2 cups frozen peas and carrots', state: 'in pantry' },
        { name: '3 medium potatoes, diced', state: 'missing item' },
        { name: '4 cups chicken broth', state: 'in pantry' },
        { name: '1 cup heavy cream', state: 'in pantry' },
        { name: '3 tbsp butter', state: 'in pantry' },
        { name: '3 tbsp flour', state: 'in pantry' },
        { name: 'Thyme, salt, pepper', state: 'in pantry' },
      ],
      instructions: [
        'Melt butter in a large pot. Whisk in flour and cook 1 minute.',
        'Gradually whisk in broth until smooth. Add potatoes and simmer 12 minutes.',
        'Add chicken, peas, carrots, and cream. Simmer 5 more minutes.',
        'Season with thyme, salt, and pepper. Serve with crusty bread or puff pastry crackers.',
      ],
    },
    n18: {
      id: 'n18',
      name: 'BLT Pasta Salad',
      description: 'A crowd-pleasing summer pasta salad with crispy bacon, cherry tomatoes, romaine, and a tangy ranch dressing.',
      cookTime: 20,
      serves: 8,
      rating: 4.6,
      calories: 440,
      tags: ['Crowd Pleaser', 'Lots of leftovers'],
      imageUrl: '/mock/n18.jpg',
      ingredients: [
        { name: '1 lb rotini pasta', state: 'in pantry' },
        { name: '8 strips bacon, cooked and crumbled', state: 'missing item' },
        { name: '2 cups cherry tomatoes, halved', state: 'missing item' },
        { name: '2 cups romaine, chopped', state: 'missing item' },
        { name: '¾ cup ranch dressing', state: 'in pantry' },
        { name: '¼ cup parmesan', state: 'in pantry' },
      ],
      instructions: [
        'Cook and cool pasta.',
        'Cook bacon until crispy. Drain on paper towels and crumble.',
        'Toss pasta with tomatoes, romaine, and ranch.',
        'Top with bacon and parmesan. Chill before serving.',
      ],
    },
    n19: {
      id: 'n19',
      name: 'Honey Mustard Glazed Salmon',
      description: 'Salmon fillets brushed in a tangy honey mustard glaze, roasted until caramelized. On the table in 20 minutes.',
      cookTime: 20,
      serves: 4,
      rating: 4.8,
      calories: 420,
      tags: ['Quick & Easy', 'High Protein', 'Healthy'],
      imageUrl: '/mock/n19.jpg',
      ingredients: [
        { name: '4 salmon fillets (6 oz each)', state: 'missing item' },
        { name: '3 tbsp Dijon mustard', state: 'in pantry' },
        { name: '2 tbsp honey', state: 'in pantry' },
        { name: '1 tbsp soy sauce', state: 'in pantry' },
        { name: '1 clove garlic, minced', state: 'in pantry' },
        { name: 'Lemon wedges, for serving', state: 'missing item' },
      ],
      instructions: [
        'Preheat oven to 400°F. Line a baking sheet with foil.',
        'Whisk mustard, honey, soy sauce, and garlic.',
        'Place salmon skin-side down. Brush generously with glaze.',
        'Roast 12–15 minutes until salmon flakes easily. Serve with lemon.',
      ],
    },
    n20: {
      id: 'n20',
      name: 'Shakshuka',
      description: 'Eggs poached in a spiced tomato and pepper sauce. A dramatic, one-pan brunch or weeknight dinner.',
      cookTime: 25,
      serves: 4,
      rating: 4.8,
      calories: 310,
      tags: ['Vegetarian', 'One Pan', 'Brunch'],
      imageUrl: '/mock/n20.jpg',
      ingredients: [
        { name: '6 large eggs', state: 'in pantry' },
        { name: '1 can crushed tomatoes (28 oz)', state: 'in pantry' },
        { name: '1 red bell pepper, diced', state: 'missing item' },
        { name: '1 onion, diced', state: 'in pantry' },
        { name: '4 cloves garlic', state: 'in pantry' },
        { name: '1 tsp cumin, smoked paprika, chili powder', state: 'in pantry' },
        { name: 'Feta, fresh parsley, crusty bread', state: 'missing item' },
      ],
      instructions: [
        'Sauté onion and pepper until soft. Add garlic and spices, cook 1 minute.',
        'Pour in crushed tomatoes. Simmer 10 minutes.',
        'Make 6 wells in the sauce and crack an egg into each.',
        'Cover and cook 6–8 minutes until whites are set. Top with feta and parsley.',
      ],
    },
    n21: {
      id: 'n21',
      name: 'Crispy Tofu Noodle Bowl',
      description: 'Extra-firm tofu cubed and crisped in a hot wok, served over rice noodles with a peanut-ginger sauce and fresh herbs.',
      cookTime: 25,
      serves: 4,
      rating: 4.6,
      calories: 440,
      tags: ['Vegan', 'Plant-Forward'],
      imageUrl: '/mock/n21.jpg',
      ingredients: [
        { name: '14 oz extra-firm tofu, pressed and cubed', state: 'missing item' },
        { name: '8 oz rice noodles', state: 'in pantry' },
        { name: '3 tbsp peanut butter', state: 'in pantry' },
        { name: '2 tbsp soy sauce', state: 'in pantry' },
        { name: '1 tbsp fresh ginger, grated', state: 'missing item' },
        { name: '1 tbsp rice vinegar', state: 'missing item' },
        { name: 'Cucumber, shredded carrots, cilantro, lime', state: 'missing item' },
      ],
      instructions: [
        'Soak rice noodles per package. Drain and set aside.',
        'Fry tofu in hot oil until golden and crisp on all sides, about 10 minutes.',
        'Whisk peanut butter, soy sauce, ginger, vinegar, and 2 tbsp water for sauce.',
        'Toss noodles with sauce. Top with tofu, cucumber, carrots, cilantro, and lime.',
      ],
    },
    n22: {
      id: 'n22',
      name: 'Carne Asada Rice Bowls',
      description: 'Citrus-marinated flank steak sliced thin over cilantro lime rice with black beans, pico de gallo, and crema.',
      cookTime: 30,
      serves: 4,
      rating: 4.9,
      calories: 620,
      tags: ['High Protein', 'Family Favorite'],
      imageUrl: '/mock/n22.jpg',
      ingredients: [
        { name: '1.5 lbs flank steak', state: 'missing item' },
        { name: '2 cups long-grain white rice', state: 'in pantry' },
        { name: '1 can black beans, drained', state: 'in pantry' },
        { name: '1 cup pico de gallo', state: 'missing item' },
        { name: '¼ cup fresh cilantro', state: 'missing item' },
        { name: 'Orange juice, lime juice, garlic, cumin', state: 'in pantry' },
        { name: 'Sour cream or crema', state: 'in pantry' },
      ],
      instructions: [
        'Marinate steak in orange juice, lime, garlic, and cumin for 15 minutes.',
        'Grill or sear over high heat, 4–5 min per side. Rest 5 minutes, then slice thin against the grain.',
        'Cook rice. Stir in lime juice and cilantro.',
        'Assemble bowls with rice, beans, steak, pico de gallo, and crema.',
      ],
    },
    n23: {
      id: 'n23',
      name: 'Mushroom Risotto',
      description: 'Silky arborio rice slowly coaxed into a rich, parmesan-laced risotto with sautéed cremini and shiitake mushrooms.',
      cookTime: 45,
      serves: 4,
      rating: 4.7,
      calories: 510,
      tags: ['Vegetarian', 'Impressive', 'Comfort Food'],
      imageUrl: '/mock/n23.jpg',
      ingredients: [
        { name: '1½ cups arborio rice', state: 'in pantry' },
        { name: '2 cups cremini mushrooms, sliced', state: 'missing item' },
        { name: '1 cup shiitake mushrooms, sliced', state: 'missing item' },
        { name: '5 cups warm vegetable broth', state: 'in pantry' },
        { name: '½ cup dry white wine', state: 'missing item' },
        { name: '1 shallot, minced', state: 'missing item' },
        { name: '½ cup parmesan, grated', state: 'in pantry' },
        { name: '2 tbsp butter, 2 tbsp olive oil', state: 'in pantry' },
      ],
      instructions: [
        'Sauté mushrooms in olive oil until golden. Set aside.',
        'Sauté shallot in butter. Add arborio and toast 1 minute.',
        'Add wine and stir until absorbed. Add broth one ladle at a time, stirring constantly.',
        'After 25 minutes when rice is al dente, stir in mushrooms, parmesan, and butter.',
      ],
    },
    n24: {
      id: 'n24',
      name: 'Coconut Curry Shrimp',
      description: 'Plump shrimp simmered in a fragrant coconut milk curry with red peppers and spinach. Ready in 20 minutes.',
      cookTime: 20,
      serves: 4,
      rating: 4.8,
      calories: 400,
      tags: ['Quick & Easy', 'High Protein'],
      imageUrl: '/mock/n24.jpg',
      ingredients: [
        { name: '1 lb large shrimp, peeled', state: 'missing item' },
        { name: '1 can coconut milk (14 oz)', state: 'in pantry' },
        { name: '2 tbsp red curry paste', state: 'in pantry' },
        { name: '1 red bell pepper, sliced', state: 'missing item' },
        { name: '2 cups baby spinach', state: 'missing item' },
        { name: '1 tbsp fish sauce', state: 'in pantry' },
        { name: '1 tbsp lime juice', state: 'in pantry' },
        { name: 'Jasmine rice, for serving', state: 'in pantry' },
      ],
      instructions: [
        'Fry curry paste in a bit of oil for 1 minute until fragrant.',
        'Pour in coconut milk and fish sauce. Simmer 5 minutes.',
        'Add pepper and shrimp. Cook 3–4 minutes until shrimp are pink.',
        'Stir in spinach and lime juice. Serve over jasmine rice.',
      ],
    },
    n25: {
      id: 'n25',
      name: 'Breakfast Burritos',
      description: 'Scrambled eggs, crispy breakfast sausage, melted cheddar, and home fries wrapped in a warm flour tortilla.',
      cookTime: 25,
      serves: 4,
      rating: 4.8,
      calories: 580,
      tags: ['Brunch', 'Kid-Friendly', 'Crowd Pleaser'],
      imageUrl: '/mock/n25.jpg',
      ingredients: [
        { name: '8 large eggs', state: 'in pantry' },
        { name: '4 breakfast sausage links, sliced', state: 'missing item' },
        { name: '4 large flour tortillas', state: 'in pantry' },
        { name: '1 cup cheddar cheese, shredded', state: 'in pantry' },
        { name: '2 medium potatoes, diced and roasted', state: 'missing item' },
        { name: '¼ cup milk', state: 'in pantry' },
        { name: 'Salsa and hot sauce, for serving', state: 'in pantry' },
      ],
      instructions: [
        'Roast diced potatoes with oil and seasoning at 425°F for 20 minutes.',
        'Cook sausage in a skillet until browned.',
        'Whisk eggs with milk. Scramble over medium-low heat until just set.',
        'Warm tortillas. Layer eggs, sausage, potatoes, and cheese. Roll tight.',
        'Toast burritos seam-side down in the skillet for 1 minute.',
      ],
    },
    r5: {
      id: 'r5',
